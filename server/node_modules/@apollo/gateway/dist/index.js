...
class ApolloGateway {
    constructor(config) {
        ...
        this.experimental_didResolveQueryPlan = config === null || config === void 0 ? void 0 : config.experimental_didResolveQueryPlan;
        this.experimental_didFailComposition = config === null || config === void 0 ? void 0 : config.experimental_didFailComposition;
        this.experimental_didUpdateComposition = config === null || config === void 0 ? void 0 : config.experimental_didUpdateComposition;
    ...
    async load(options) {
        if (this.state.phase !== 'initialized') {
            throw Error('ApolloGateway.load called in surprising state ${this.state}');
        }
